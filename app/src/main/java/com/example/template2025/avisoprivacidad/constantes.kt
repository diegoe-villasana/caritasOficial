package com.example.template2025.avisoprivacidad

// Define la constante de texto para el aviso de privacidad
const val AVISO_PRIVACIDAD = """
AVISO DE PRIVACIDAD

Cáritas de Monterrey respeta su privacidad y se compromete a proteger sus datos personales. Este aviso de privacidad le informa sobre nuestras prácticas de recopilación, uso, divulgación y protección de su información personal.
...
Si tiene alguna pregunta o inquietud sobre nuestro aviso de privacidad, comuníquese con nosotros a través de https://www.caritas.org.mx/.
